        ...
        <SidebarContent className="py-[60px] bg-white">
          ...
          <SidebarHeader className="px-3 pb-0">
            {isCollapsed ? <Tooltip>
              ...
              </Tooltip> : <Button variant="default" className="w-full justify-start h-9 bg-primary text-primary-foreground hover:bg-primary/90" onClick={handleNewProject}>
              ...
              <SidebarMenu>
                {mainMenuItems.map(item => <SidebarMenuItem key={item.title}>
                    {isCollapsed ? <Tooltip>
                      ...
                      </Tooltip> : <SidebarMenuButton asChild isActive={isActive(item.url)} className={isActive(item.url) ? "bg-[hsl(var(--sidebar-selected))] text-[hsl(var(--sidebar-selected-foreground))]" : "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"}>
          ...
          {/* 项目内导航 - 当有选中项目时常驻显示 */}
          {shouldShowProjectNavigation && <SidebarGroup className="my-0 py-0 rounded-lg mb-2 mx-0 bg-transparent">
              {!isCollapsed && <SidebarGroupLabel className="text-xs text-muted-foreground px-3 pt-2 pb-1">
                  项目模块
                </SidebarGroupLabel>}
              <SidebarGroupContent className="pb-2">
                ...
                return <SidebarMenuItem key={item.id}>
                        {isCollapsed ? <Tooltip>
                            <TooltipTrigger asChild>
                              <SidebarMenuButton asChild isActive={isActiveView} className={isActiveView ? "bg-[hsl(var(--sidebar-selected))] text-[hsl(var(--sidebar-selected-foreground))] mx-1" : "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground mx-1"}>
                          ...
                          </Tooltip> : <SidebarMenuButton asChild isActive={isActiveView} className={isActiveView ? "bg-[hsl(var(--sidebar-selected))] text-[hsl(var(--sidebar-selected-foreground))] mx-1" : "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground mx-1"}>
