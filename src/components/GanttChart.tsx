        ...
        <div className="overflow-x-auto">
          <div className="min-w-full">
            ...
            gridTemplateColumns: "200px 1fr"
              ...
              {/* 固定表头 */}
              <div className="sticky top-0 bg-background z-10 contents">
                {/* 任务列表标题 */}
                ...
                <div className="bg-muted/50 border-b">
                  ...
                  minWidth: `${totalDays * 40}px`
                    ...
                    {dateHeaders.map(header => <div key={header.day} className={`border-r border-border/50 flex flex-col items-center justify-center text-xs p-1 ${header.dayOfWeek === 0 || header.dayOfWeek === 6 ? 'bg-muted/70 text-muted-foreground' : ''}`}>
              ...
              {/* 可滚动的甘特图主体 */}
              <div className="max-h-96 overflow-y-auto contents">
                {timelineData.map((item, index) => <div key={item.id} className="contents">
                    {/* 任务名称列 */}
                    ...
                    minWidth: `${totalDays * 40}px`
                        ...
                        {/* 网格背景 */}
                        {dateHeaders.map(header => <div key={header.day} className={`border-r border-border/20 ${header.dayOfWeek === 0 || header.dayOfWeek === 6 ? 'bg-muted/30' : ''}`} />)}
