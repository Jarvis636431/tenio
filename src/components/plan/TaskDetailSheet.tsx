...
interface TaskDetailSheetProps {
  ...
  isEditMode: boolean;
  editedItem: TaskItem | null;
  onEditClick: (item: TaskItem) => void;
  onSaveEdit: () => void;
  onCancelEdit: () => void;
  onEditedItemChange: (item: TaskItem | null) => void;
}
      ...
      return (
        <div>
          ...
          <Input
            ...
            onChange={(e) => onEditedItemChange(editedItem ? { ...editedItem, [field]: e.target.value } : null)}
            className="mt-1"
          />
        </div>
      );
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {renderField("层数", `${selectedItem.floor || 0}层`, "floor")}
